...
class MotorCommands(metaclass=Metaclass_MotorCommands):
    ...
    def __init__(self, **kwargs):
        ...
        if 'motor_values' not in kwargs:
            self.motor_values = numpy.zeros(5, dtype=numpy.int16)
        else:
    ...
    def motor_values(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 5, \
                "The 'motor_values' numpy.ndarray() must have a size of 5"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'motor_values' field must be a set or sequence with length 5 and each value of type 'int' and each integer in [-32768, 32767]"
