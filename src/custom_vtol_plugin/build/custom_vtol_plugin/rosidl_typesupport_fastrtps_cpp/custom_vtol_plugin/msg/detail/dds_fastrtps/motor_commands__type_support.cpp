...
#include "custom_vtol_plugin/msg/detail/motor_commands__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_vtol_plugin
cdr_serialize(
  const custom_vtol_plugin::msg::MotorCommands & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: motor_values
  {
    cdr << ros_message.motor_values;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_vtol_plugin::msg::MotorCommands & ros_message)
{
  // Member: motor_values
  {
    cdr >> ros_message.motor_values;
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 4;
    size_t item_size = sizeof(ros_message.motor_values[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_vtol_plugin::msg::MotorCommands;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_vtol_plugin::msg::MotorCommands *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_vtol_plugin::msg::MotorCommands *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_custom_vtol_plugin
const rosidl_message_type_support_t *
get_message_type_support_handle<custom_vtol_plugin::msg::MotorCommands>()
{
  return &custom_vtol_plugin::msg::typesupport_fastrtps_cpp::_MotorCommands__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_vtol_plugin, msg, MotorCommands)() {
  return &custom_vtol_plugin::msg::typesupport_fastrtps_cpp::_MotorCommands__handle;
}
