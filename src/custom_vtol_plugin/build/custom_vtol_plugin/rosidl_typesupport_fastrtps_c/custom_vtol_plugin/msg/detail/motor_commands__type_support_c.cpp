...
#include "custom_vtol_plugin/msg/detail/motor_commands__rosidl_typesupport_fastrtps_c.h"
...
#include "custom_vtol_plugin/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _MotorCommands__ros_msg_type = custom_vtol_plugin__msg__MotorCommands;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: motor_values
  {
    size_t size = 4;
    auto array_ptr = ros_message->motor_values;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_vtol_plugin
size_t get_serialized_size_custom_vtol_plugin__msg__MotorCommands(
  const void * untyped_ros_message,
...
static uint32_t _MotorCommands__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_vtol_plugin__msg__MotorCommands(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_vtol_plugin
size_t max_serialized_size_custom_vtol_plugin__msg__MotorCommands(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_vtol_plugin__msg__MotorCommands;
    is_plain =
      (
      offsetof(DataType, motor_values) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _MotorCommands__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_vtol_plugin__msg__MotorCommands(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_vtol_plugin, msg, MotorCommands)() {
